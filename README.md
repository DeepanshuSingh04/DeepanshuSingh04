...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=250&color=royal blue&text=Deepanshu%20Singh&fontAlignY=40&desc=Full%20Stack%20Developer%20%7C%20DSA%20Learner%20%7C%20AI-ML%20Explorer&descAlignY=60"/>
...
class Deepanshu {
   ...
   String learning = "Java + DSA + Web Development";
   String currentGoal = "Software Engineering Internship";
   String motto = "Progress over perfection";
}
```

* 🌱 Currently improving problem solving daily
* 💻 Building projects while learning development
...
| Project                     | Tech        | Status     |
| --------------------------- | ----------- | ---------- |
| DSA Practice Repository     | Java        | 🚧 Ongoing |
| Portfolio Website           | HTML CSS JS | ✅ Complete |
| Mini Java Projects          | Java        | 🚧 Ongoing |
| Upcoming Full Stack Project | MERN        | 🔜 Soon    |
...
### ⭐ If you like my repositories, consider starring them.
